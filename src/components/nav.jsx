...
function Nav() {
  return (
    <div className="flex items-center justify-center text-[#181818] dark:text-[#DDDAD8] ">
      <svg
        width="400"
        height="521"
        viewBox="0 0 400 521"
      ...
      <ul className="flex flex-col gap-8 tems-center justify-evenly py-2.5  h-[300px]   overflow-scroll snap-mandatory snap-y absolute bottom-0">
        <li className="bg-linear-180 from-black to-[#DDDAD8]  dark:from-[#DDDAD8]  dark:to-[#1D1D1D] w-[200px] h-[51px] rounded-t-[0.5rem] p-[1px] flex items-center justify-center grow-0 basis-full snap-center scroll-m-5 scroll-me-5">
          <Link
            to="/homePage"
            className="bg-[#DDDAD8] dark:bg-[#1D1D1D] w-full h-[50px] text-[#181818] dark:text-[#DDDAD8] content-center rounded-t-[0.5rem] text-center"
          >
            Home
          </Link>
        </li>
        <li className="bg-linear-180 from-[#1D1D1D] to-[#DDDAD8] dark:from-[#DDDAD8]  dark:to-[#1D1D1D] w-[200px] h-[51px] rounded-t-[0.5rem] p-[1px] flex items-center justify-center grow-0 basis-full snap-center scroll-m-5 scroll-me-5">
          <Link
            to="/colorPage"
            className="bg-[#DDDAD8] dark:bg-[#1D1D1D] w-full h-[50px] text-[#181818] dark:text-[#DDDAD8] content-center rounded-t-[0.5rem] text-center"
          >
